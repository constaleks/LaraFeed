        ...
        <div className="min-h-screen bg-gradient-to-br from-muted/60 via-background to-background text-foreground flex justify-center">
            <div className="flex w-full max-w-7xl">
                ...
                <aside className="hidden xl:flex w-80 shrink-0 flex-col gap-4 px-4 py-4 sticky top-0 h-screen">
                    <div className="rounded-2xl border border-border bg-card p-4 text-card-foreground backdrop-blur-sm">
                        <h2 className="mb-2 text-xl font-bold">What's happening</h2>
                        <div className="flex flex-col gap-4 text-sm">
                            <div>
                                <p className="text-muted-foreground">Trending</p>
                                <p className="font-bold">Lorem Ipsum</p>
                                <p className="text-muted-foreground">12.3K likes</p>
                            </div>
                            <div>
                                <p className="text-muted-foreground">Trending</p>
                                <p className="font-bold">Dolor Sit Amet</p>
                                <p className="text-muted-foreground">8,921 likes</p>
                            </div>
                            <div>
                                <p className="text-muted-foreground">Trending</p>
                                <p className="font-bold">Consectetur Adipiscing</p>
                                <p className="text-muted-foreground">5,204 likes</p>
                            </div>
                        </div>
                    </div>
